        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomFieldDefinitions_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryTags", x => new { x.InventoriesId, x.TagsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MultiText1 = table.Column<string>(type: "text", nullable: false),
                    MultiText2 = table.Column<string>(type: "text", nullable: false),
                    MultiText3 = table.Column<string>(type: "text", nullable: false),
                    ...
                    Document1 = table.Column<string>(type: "text", nullable: false),
                    Document2 = table.Column<string>(type: "text", nullable: false),
                    Document3 = table.Column<string>(type: "text", nullable: false),
                    Boolean1 = table.Column<bool>(type: "boolean", nullable: true),
                    Boolean2 = table.Column<bool>(type: "boolean", nullable: true),
                    Boolean3 = table.Column<bool>(type: "boolean", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldDefinitions_InventoryId_FieldType_FieldIndex",
                table: "CustomFieldDefinitions",
                columns: new[] { "InventoryId", "FieldType", "FieldIndex" },
                unique: true);
